...
class ViewController: UIViewController {
    ...
    // add SecondChildVC programmatically
    ...
    // add contraints for SecondChildVC
    func childVCConstraints(_ vc: UIViewController) {
        vc.view.translatesAutoresizingMaskIntoConstraints = false
        vc.view.bottomAnchor.constraint(equalTo: view.safeAreaLayoutGuide.bottomAnchor, constant: -200).isActive = true
